...
layout = html.Div([
    ...
    html.Div('Inorganic Chemistry, (Submitted) January 1, 2025', className = 'ta'),
    ...
    html.Div('npj Quantum Materials, April 4, 2022', className = 'ta'),
    dcc.Link('Vibrational fingerprints of ferroelectric HfO<sub>2</sub>',
    ...
    dcc.Link('Band-Mott mixing hybridizes the gap in Fe<sub>2</sub>Mo<sub>3</sub>O<sub>8</sub>', 
